    ...
    <div className={styles[`header__links-container`]}>
      <div className={styles[`header__links-container-btn`]}>
        <IconButton onClick={MenuButtonHandler}>
          {menuIsOpen ? <ClearIcon /> : <DensityMediumIcon />}
        </IconButton>
      </div>
      ...
      <div
        className={`${
          menuIsOpen
            ? styles[`header__links-container-wrapper-active`]
            : styles[`header__links-container-wrapper`]
        }`}
      >
        {links &&
          links.map((link: HeaderLink, i: number) => {
            return (
              <Link
                href={link.src}
                key={i}
                className={styles[`header__links-container-links`]}
              >
